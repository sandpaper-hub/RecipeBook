...
Проект разработан как **пет-проект для портфолио Android-разработчика** с фокусом на **современный Android-стек, чистую архитектуру и best practices**.
...
Такой подход упрощает масштабирование и тестирование приложения.
...
- формирования портфолио Android-разработчика